...
export default function ClientesList() {
  ...
  // Estado do dialog de confirma��o
  ...
  return (
    <>
      ...
      {/* Dialog de confirma��o de exclus�o */}
      <ConfirmDialog
        ...
        description={`Tem certeza que deseja excluir o cliente "${deleteConfirm.clienteNome}"? Esta a��o n�o pode ser desfeita.`}
